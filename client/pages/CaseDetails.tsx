...
export default function CaseDetails() {
  ...
  const [hearingsData, setHearingsData] = useState([
    ...
    },
    {
      ...
      appearedBy: "Priya Sharma",
      notes:
        "Initial hearing completed. Case registered successfully. Next hearing for bail application scheduled.",
      documentsDiscussed: "FIR copy, Complaint application, Legal notice",
      aiSummary:
        "First hearing conducted successfully. Court registered the case and scheduled next hearing for bail application.",
  ...
  const loadHearings = () => {
    ...
    const now = new Date();
    const upcoming = hearingsData.filter(
      (hearing) => new Date(hearing.date) > now,
    );
    const past = hearingsData.filter(
      (hearing) => new Date(hearing.date) <= now,
    );
      ...
      <div key={hearing.id} className="hearing-item">
        ...
        <div className="hearing-actions">
          <button
            ...
            onClick={() => editHearing(hearing.id)}
          >
            <i className="fas fa-edit"></i> Edit
          </button>
          <button
            className="action-btn view"
            onClick={() => viewHearingDetails(hearing.id)}
          >
  ...
  const now = new Date();
  const upcomingHearings = hearingsData.filter(
    (hearing) => new Date(hearing.date) > now,
  );
  const pastHearings = hearingsData.filter(
    (hearing) => new Date(hearing.date) <= now,
  );
                ...
                <div className="main-details">
                  ...
                  <div className="detail-section">
                    ...
                    <div className="section-content">
                      ...
                      >
                        The case involves allegations of cheating and criminal
                        breach of trust against the accused John Doe. The
                        complainant alleges that the accused fraudulently
                        obtained Rs. 5,00,000 by promising to deliver
                        construction materials for a residential project but
                        failed to deliver as per the agreement.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    {[
                      {
                        ...
                        date: "Dec 22, 2023",
                        description:
                          "Bail application submitted to the court for the accused.",
                      },
                      {
                        title: "FIR Received",
                        date: "Dec 20, 2023",
                        description:
                          "Copy of FIR obtained from the police station.",
                      },
                      {
                        title: "Case Filed",
                        date: "Dec 18, 2023",
                        description:
                          "Initial case registration and client consultation completed.",
                      },
                    ].map((event, index) => (
              ...
              <div className="ai-assistant-container">
                  ...
                  <div className="ai-summary-content">
                    <div className="case-summary-card">
                      ...
                      <p className="summary-text">
                        Criminal case involving economic offense under Section
                        420 IPC. Client seeking anticipatory bail.
                      </p>
                    </div>
                    ...
                    <div className="ai-suggestions">
                      <div className="suggestion-column">
                        ...
                        <ul className="suggestion-list">
                          <li>
                            <span className="priority-high">●●●</span> Previous
                            bail precedents in economic offense cases
                          </li>
                          <li>
                            <span className="priority-medium">●●</span> Clear
                            criminal record of the accused
                          </li>
                          <li>
                            <span className="priority-low">●</span> Cooperation
                            with investigation
                          </li>
                        </ul>
                      </div>
                ...
                <div className="ai-chat-section">
                  <div className="section-header">
                    ...
                    <span className="ai-badge">
                      Chat with AI for case-specific guidance and analysis
                    </span>
                  </div>
                    ...
                    <div className="chat-input-area">
                      <div className="quick-actions">
                        <button
                          ...
                          onClick={() => sendQuickMessage("Analyze Documents")}
                        >
                          <i className="fas fa-file-alt"></i> Analyze Documents
                        </button>
                        <button
                          className="quick-action-btn"
                          onClick={() => sendQuickMessage("Suggest Arguments")}
                        >
                          <i className="fas fa-balance-scale"></i> Suggest
                          Arguments
                        </button>
                        <button
                          className="quick-action-btn"
                          onClick={() => sendQuickMessage("Draft Motion")}
                        >
                          <i className="fas fa-edit"></i> Draft Motion
                        </button>
                        <button
                          className="quick-action-btn"
                          onClick={() => sendQuickMessage("Risk Assessment")}
                        >
